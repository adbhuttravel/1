...
const teamMembers = [
  { name: "Mr. Mohit Sharma", role: "Founder & CEO",image: "/images/media/About Us/Mohit Adbhut Founder.webp", dataAiHint: "man portrait" },
  { name: "Mrs. Aditi Sharma", role: "Sales Director", image: "/images/media/About Us/Mrs. Aditi Sharma.webp", dataAiHint: "woman portrait" },
  { name: "Mr. Sachin", role: "Head of Operations", image: "/images/media/About Us/Sachin-OPS-Manager-Adbhut-Travel-Event-Pvt.-Ltd.webp", dataAiHint: "man portrait" },
  { name: "Mr. Ankit", role: "Business Development Manager (BDM)", image: "/images/media/About Us/Anku D.Dun.webp", dataAiHint: "man portrait" },
];
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/images/media/About Us/Our Story.webp"
            ...
            <div className="flex flex-col items-center">
                <div className="mb-4 flex items-center justify-center h-16">
                    <Link href="https://www.northcabs.in/" target="_blank" rel="noopener noreferrer" className="transition-transform duration-300 hover:-translate-y-1">
                        <Image src="/images/media/About Us/NorthCabs.webp" alt="North Cab Logo" width={200} height={80} className="max-h-12 w-auto object-contain" />
                    </Link>
                </div>
            ...
            <div className="flex flex-col items-center">
                <div className="mb-4 flex items-center justify-center h-16">
                    <Link href="https://visitkurukshetra.in/" target="_blank" rel="noopener noreferrer" className="transition-transform duration-300 hover:-translate-y-1">
                        <Image src="/images/media/About Us/visitkurukshetra_logo.webp" alt="Visit Kurukshetra Logo" width={250} height={80} className="max-h-12 w-auto object-contain" />
                    </Link>
                </div>
