...
const internationalPackages: Package[] = [
  {
    ...
    image: '/images/media/Home/Feature Singapore.webp',
    dataAiHint: 'Malaysia city skyline',
    duration: '04 Nights / 05 Days',
    packageType: '(Couple)',
    facilities: ['flight', 'hotel', 'transport', 'meals', 'visa'],
    gallery: [
        '/images/media/Home/Feature Singapore.webp'
    ],
  ...
  },
  {
    ...
    image: '/images/media/Home/Feature Bali.webp',
    ...
    gallery: [
      '/images/media/Home/Feature Bali.webp'
    ],
...
export default function Home() {
  return (
    <div className="flex flex-col">
      <Hero />
      <ThemeCategories id="theme-categories" />
      <GroupImagesCarousel />
