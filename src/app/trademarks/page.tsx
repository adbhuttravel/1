...
const logos = [
  { src: '/images/media/Trademarks/Adbhut Travel Agency Logo.webp', alt: 'Adbhut Travel Agency Logo', width: 250, height: 80 },
  { src: '/images/media/Trademarks/adbhut.webp', alt: 'Adbhut Wordmark Logo', width: 250, height: 80 },
  { src: '/images/media/Trademarks/visitkurukshetra_logo.webp', alt: 'VisitKurukshetra.in Logo', width: 250, height: 80 },
  { src: '/images/media/Trademarks/Adbhut-Foundation.webp', alt: 'Adbhut Foundation Logo', width: 250, height: 80 },
  { src: '/images/media/Trademarks/NorthCabs.webp', alt: 'North Cabs Logo', width: 200, height: 80 },
  { src: '/images/media/Trademarks/Home2Home.webp', alt: 'Home2Home Logo', width: 250, height: 80 },
];
