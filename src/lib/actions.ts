...
export async function submitTermsOfServiceForm(
  ...
  <html>
    ...
    <body>
      <div class="wrapper">
        <div class="container">
          <img src="https://adbhuttravel.in/images/media/adbhut-logo.webp" alt="Adbhut Travel Logo" class="logo">
            ...
            <td align="center">
              <div class="footer-content">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr><td align="center" style="padding-bottom: 32px;"><img src="https://adbhuttravel.in/images/media/Home/Adbhut-Affilications-Cetifications.webp" alt="Certifications" style="max-width: 100%; height: auto;" /></td></tr>
                  <tr>
                    <td>
                      <table class="footer-links-table" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td>
                            <img src="https://adbhuttravel.in/images/media/adbhut-logo.webp" alt="Adbhut Logo" class="footer-logo" />
